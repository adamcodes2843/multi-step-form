        ...
        { formData.plan === "Arcade" ?
            ...
            <Image src={arcadeIcon} alt="arcade icon" width="50" height="50" />
                <div className="flex flex-col items-start">
                    <h3 className="font-bold text-xl md:pt-12">Arcade</h3>
                    <p className="font-bold opacity-50 text-lg">
                    {isChecked ? "$90/yr" : "$9/mo"}
                    </p>
                    {isChecked ? <p className="font-semibold text-left lg:text-base">2 months free</p> : <p className="font-semibold text-left lg:text-base hidden xl:block xl:opacity-0">2 months free</p>}
                </div>
            </button>
            :
            ...
            <Image src={arcadeIcon} alt="arcade icon" width="50" height="50" />
                <div className="flex flex-col items-start">
                    ...
                    {isChecked ? <p className="font-semibold text-left lg:text-base md:font-normal">2 months free</p> : <p className="font-semibold text-left lg:text-base hidden xl:block xl:opacity-0">2 months free</p>}
                </div>
            </button>
        }
    </>
