...
const Content2 = ({formData, setFormData, isChecked, setIsChecked}: Content2Props) => {
  ...
  return (
    <div className="content2 bg-white mt-28 md:mt-0 fixed md:static w-11/12 rounded-xl px-6 xl:py-8 md:pt-4 md:py-0 py-4 md:col-start-2 md:w-full md:flex md:flex-col">
