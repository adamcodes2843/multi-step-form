...
const ThankYou = () => {
  return (
    <div className="thankYou bg-white mt-24 fixed  md:mt-0 md:static w-11/12 rounded-xl px-8 py-20 md:py-24 flex flex-col justify-center items-center text-center">
        ...
        <h2 className="text-lg md:text-xl opacity-40 leading-8 md:flex md:justify-center md:w-96 xl:text-lg">Thanks for confirming you subscription! We hope you have fun using our platform. If you ever need support, please feel free to email us at support@lormgaming.com.</h2>
