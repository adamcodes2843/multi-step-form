        ...
        { formData.plan === "Advanced" ?
            <button type="button" className="row-start-2 row-end-3 border-2 rounded-lg p-4 flex flex-row md:flex-col md:justify-between gap-4 border-indigo-600 bg-indigo-50 md:w-1/3" onClick={advancedPlan}>
                ...
                <div className="flex flex-col items-start">
                    <h3 className="font-bold text-lg md:text-xl md:pt-12">Advanced</h3>
                    <p className="font-bold opacity-50 md:text-lg">
                    {isChecked ? "$120/yr" : "$12/mo"}
                    </p>
                    {isChecked ? <p className="font-semibold text-left md:text-base text-sm">2 months free</p> : <p className="hidden xl:block font-semibold text-left md:text-base text-sm xl:opacity-0">2 months free</p>}
                </div>
            </button>
            :
